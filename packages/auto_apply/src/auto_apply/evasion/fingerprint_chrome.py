...
COMMON_WEBGL_VENDORS = ["Google Inc. (NVIDIA)", "Google Inc. (AMD)", "Apple Inc.", "Google Inc. (Intel)"]
...
def spoof_webgl(driver: WebDriver, strategy: Literal["random", "custom"], vendor: str, renderer: str) -> None:
