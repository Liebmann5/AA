...
from .. import fingerprint_chrome
from .. import fingerprint_firefox
...
class SeleniumEvasionStrategy(EvasionStrategyInterface):
    ...
    def apply_static_evasion(self) -> None:
        ...
        try:
            ...
            logger.warning("The provided browser adapter does not have 'get_raw_driver' Skipping Selenium evasions")
        ...
        if 'chrome' in browser_name or 'edge' in browser_name:
            ...
            logger.warning(f"No specialized static evasion tactics for browser '{browser_name}'.")
